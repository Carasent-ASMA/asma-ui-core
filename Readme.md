...
- When creating a "composed component" evaluate if it's really needed to create a composed component, or just document how to use the styled components.
...
import { defaultTheme, customPalettes } from 'asma-ui-core';
