...
import { AssignmentIconStory } from './assignment/AssignmentIconStory'
import { AssignmentOutlineIconStory } from './assignment-outline-icon/AssignmentOutlineIconStory'
...
import { PersonOutlineIconStory } from './person-outline-icon/PersonOutlineIconStory'
...
import { PermMediaOutlineStory } from './perm-media-outline-icon/PermMediaOutlineStory'
import { FindReplacePeopleIconStory } from './find-replace-people-icon/FindReplacePeopleIconStory'
export default {
    title: 'Icons',
    component: Icons,
...
export const FindReplacePeople = FindReplacePeopleIconStory()
...
export const PermMediaOutline = PermMediaOutlineStory()
...
export const PersonOutline = PersonOutlineIconStory()
...
export const AssignmentOutline = AssignmentOutlineIconStory()
export const AssignmentIcon = AssignmentIconStory()
